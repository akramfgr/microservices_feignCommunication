...
public class ClientController {
    ...
    @FeignClient(name="SERVICE-VOITURE",url="http://localhost:8089")
    ...
    public List<Voiture> getVoituresByClientId(@PathVariable Long id) {
        return voitureService.voitureByClientId(id);
    }
